...
public class CombineServiceNew {
    ...
    private static final int RATIO_KICH_AN = 30;
    ...
    public static final int KHAM_NGOC_BOI = 531;
    public static final int KICH_AN = 532;
    public static final int DOI_AN = 533;
    public static final int SACH_TUYET_KI = 534;
    public static final int CHE_TAO_PHOI = 535;
        ...
        switch (player.combineNew.typeCombine) {
                ...
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (bongTai != null && manhVo != null && manhVo.quantity >= 999) {
                        ...
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Bông tai Porata và x999 Mảnh vỡ bông tai", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Bông tai Porata và x999 Mảnh vỡ bông tai", "Đóng");
            ...
            case NANG_CAP_BONG_TAI_2_LEN_3:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Bông tai Porata 2 và x999 Mảnh vỡ bông tai", "Đóng");
                }
                break;
            case MO_CHI_SO_BONG_TAI_CAP3:
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    if (bongTai != null && thachPhu != null && thachPhu.quantity >= 99 && daXanhLam != null) {
                        ...
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Bông tai Porata cấp 3, 99 Mảnh Hồn, 1 Đá xanh lam và 99 thạch phù", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "|2|Cần 1 Bông tai Porata cấp 3, 99 Mảnh Hồn, 1 Đá xanh lam và 99 thạch phù", "Đóng");
                }
                break;
            ...
            case NANG_CAP_BONG_TAI_CAP5:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (bongTai != null && mvbt != null && mvbt.quantity >= 99) {
...
//                            + "|7|Phí nâng cấp: 500 triệu vàng";
            ...
            case NANG_CAP_SKH_VIP:
                ...
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    String npcSay = "NÂNG CẤP TRANG BỊ KÍCH HOẠT VIP\n"
                    ...
                    this.baHatMit.createOtherMenu(player, ConstNpc.MENU_NANG_SKH_LVL,
                            npcSay, "Nâng cấp\n" + Util.numberToMoney(COST) + " vàng", "Từ chối");
                } else {
                    if (player.combineNew.itemsCombine.size() > 3) {
            ...
            case NANG_CAP_SKH_THUONG:
                ...
                if (player.combineNew.itemsCombine.size() == 1) {
                    ...
                    String npcSay = "|7|NÂNG CẤP TRANG BỊ KÍCH HOẠT\n"
                            + "|2|Đã đạt đủ số lượng nguyên liệu, bạn sẽ nhận được : \n"
            ...
            case NANG_CAP_CHAN_MENH:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (bongTai != null && manhVo != null && (bongTai.template.id >= 1300 && bongTai.template.id < 1308)) {
                        ...
                        npcSay += "|1|Bạn có muốn nâng cấp chân mệnh";
                        baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
            ...
            case NANG_SKH_TL_LVL1:
                ...
                if (player.combineNew.itemsCombine.size() == 7) {
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.isDNS1() && item.quantity >= 20).count() != 1) {
                        Service.getInstance().sendThongBao(player, "Thiếu Đá nâng SKH Vip");
                        return;
                    }
            ...
            case NANG_SKH_LVL1:
                if (player.combineNew.itemsCombine.size() == 0) {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Hãy đưa ta 1 món SKH và 3 Đá Nâng SKH", "Đóng");
                    return;
                }
                if (player.combineNew.itemsCombine.size() == 2) {
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.isDNS() && item.quantity >= 3).count() != 1) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Thiếu Đá Nâng SKH", "Đóng");
                        return;
                    }
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.isSKH()).count() != 1) {
            ...
            case NANG_SKH_LVL2:
                if (player.combineNew.itemsCombine.size() == 0) {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Hãy đưa ta 1 món SKH và 5 Đá Nâng SKH", "Đóng");
                    return;
                }
                if (player.combineNew.itemsCombine.size() == 2) {
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.isDNS() && item.quantity >= 5).count() != 1) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Thiếu Đá Nâng SKH", "Đóng");
                        return;
                    }
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.isSKHLVL1()).count() != 1) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Thiếu đồ SKH", "Đóng");
                        return;
                    }
                ...
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    if (ngocrongsp != null && ngocrongsp.quantity >= 1 && dathuctinh != null && dathuctinh.quantity >= 20
                        ...
                        if (player.nPoint.dameg >= 30000 && player.nPoint.hpg >= 500000
                                && player.nPoint.mpg >= 500000 && player.nPoint.power >= 80000000000L) {
                            String npcSay = "|7|[ THỨC TỈNH BẢN THÂN ]"
                                    ...
                                    && player.nPoint.dameg >= 32000 && player.nPoint.dameg < 33000 ? "50%"
                                            ...
                                            && player.nPoint.dameg >= 33000 && player.nPoint.dameg < 34500 ? "80%" : "80%") + "\n";
                        ...
                        if (player.pet.nPoint.dameg >= 31000 && player.pet.nPoint.hpg >= 360000
                                && player.pet.nPoint.mpg >= 360000 && player.pet.nPoint.power >= 60000000000L) {
                            ...
                            this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                    ...
                                    + "Yêu cầu : Max chỉ số HP, KI, SD và sức mạnh đạt 60Tỷ trở lên", "Đóng");
                        }
                    } else {
                        this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                    ...
                    if (ngocrong != null && ngocrong.quantity >= 3
                        ...
                        String npcSay = "|7|[ THỨC TỈNH BẢN THÂN ]"
                                ...
                                && player.nPoint.dameg >= 32000 && player.nPoint.dameg < 34000 ? "50%"
                                        ...
                                        && player.nPoint.dameg >= 34000 && player.nPoint.dameg < 35000 ? "80%" : "80%") + "\n";
            ...
            case KHAM_NGOC_BOI:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    Item daKham = null;
                    for (Item item : player.combineNew.itemsCombine) {
                        if (item.template.id == 1409 || item.template.id == 1410) {
                            ngocBoi = item;
                        } else if (item.template.id == 1600 || item.template.id == 1601 || item.template.id == 1602) {
                            daKham = item;
                        }
                    }
                    if (ngocBoi != null && daKham != null) {

                        player.combineNew.goldCombine = GOLD_BONG_TAI;
                        player.combineNew.gemCombine = GEM_BONG_TAI;
                        player.combineNew.ratioCombine = RATIO_NANG_CAP;

                        String npcSay = "Khảm Ngọc Bội" + "\n|2|";
                        for (Item.ItemOption io : ngocBoi.itemOptions) {
                            npcSay += io.getOptionString() + "\n";
                        }
                        npcSay += "|7|Bạn có muốn khảm ngọc bội" + "\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine) + " vàng";
                            buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Nâng cấp\ncần " + player.combineNew.gemCombine + " ngọc");
                        } else {
                            npcSay += "Còn thiếu " + Util.numberToMoney(player.combineNew.goldCombine - player.inventory.gold) + " vàng";
                            buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Đóng");
                        }
                    } else {
                        this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Ngọc Bội và 1 Đá Khảm Ngọc Bội", "Đóng");
                    }
                } else {
                    this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Ngọc Bội và 1 Đá Khảm Ngọc Bội", "Đóng");
            ...
            case KICH_AN:
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    Item an = null;
                    for (Item item : player.combineNew.itemsCombine) {
                        if ((item.template.type == 0 || item.template.type == 1 || item.template.type == 2 || item.template.type == 3 || item.template.type == 4) && !item.isKichAn()) {
                            trangBi = item;
                        } else if (item.template.id == 1603) {
                            sachCo = item;
                        } else if (item.template.id == 1604 || item.template.id == 1605 || item.template.id == 1606) {
                            an = item;
                        }
                    }

                    if (trangBi != null && sachCo != null && an != null) {
                        player.combineNew.goldCombine = GOLD_BONG_TAI;
                        player.combineNew.gemCombine = GEM_BONG_TAI;
                        player.combineNew.ratioCombine = RATIO_NANG_CAP;

                        String npcSay = "Mở Phong Ấn Trang Bị" + "\n|2|";
                        for (Item.ItemOption io : trangBi.itemOptions) {
                            npcSay += io.getOptionString() + "\n";
                        }
                        npcSay += "|7|Bạn có muốn mở phong ấn trang bị" + "\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine) + " vàng \n";
                            npcSay += "|1| Tỉ lệ thành công là " + RATIO_KICH_AN + "%";
                            buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Nâng cấp\ncần " + player.combineNew.gemCombine + " ngọc");
                        } else {
                            npcSay += "Còn thiếu " + Util.numberToMoney(player.combineNew.goldCombine - player.inventory.gold) + " vàng";
                        ...
                        this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Trang Bị chưa kích ấn, 1 Sách Cổ và 1 Ấn", "Đóng");
                    }
                } else {
                    this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Trang Bị chưa kích ấn, 1 Sách Cổ và 1 Ấn", "Đóng");
            ...
            case DOI_AN:
                if (player.combineNew.itemsCombine.size() == 1) {
                    Item an = null;
                    for (Item item : player.combineNew.itemsCombine) {
                        if (item.template.id == 1604 || item.template.id == 1605 || item.template.id == 1606) {
                            an = item;
                        }
                    }
                    ...
                    if (an != null) {
                        ...
                        String npcSay = "|2|Đổi ấn \n";
                        npcSay += "|7|Lưu ý: Đổi Ấn mới sẽ tiêu hao 2 Ấn cũ" + "\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine) + " vàng";
                            buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Ấn Mộc", "Ấn Thủy", "Ấn Hỏa");
                        ...
                        this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần ít nhất 2 Ấn để đổi", "Đóng");
                    }
                } else {
                    this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Trang Bị, 1 Sách Cổ và 1 Ấn", "Đóng");
                }
                break;
            case SACH_TUYET_KI:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    Item sachCu = null;
                    for (Item item : player.combineNew.itemsCombine) {
                        if (item.template.id == 1459 || item.template.id == 1460 || item.template.id == 1461 || item.template.id == 1462 || item.template.id == 1464 || item.template.id == 1476) {
                            cuonSach = item;
                        } else if (item.template.id == 1599) {
                            sachCu = item;
                        }
                    }

                    if (cuonSach != null && sachCu != null) {
                        player.combineNew.goldCombine = GOLD_BONG_TAI;
                        player.combineNew.gemCombine = GEM_BONG_TAI;
                        player.combineNew.ratioCombine = RATIO_NANG_CAP;

                        String npcSay = "Nâng Cấp Cuốn Sách" + "\n|2|";
                        for (Item.ItemOption io : cuonSach.itemOptions) {
                            npcSay += io.getOptionString() + "\n";
                        }
                        npcSay += "|7|Bạn có muốn nâng cấp Cuốn Sách" + "\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine) + " vàng \n";
                            npcSay += "|1| Tỉ lệ thành công là " + RATIO_KICH_AN + "%";
                            buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                        ...
                        this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Cuốn Sách và 1 Sách Cũ", "Đóng");
                    }
                } else {
                    this.buhan.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Cuốn Sách và 1 Sách Cũ", "Đóng");
            ...
            case CHE_TAO_PHOI:
                if (player.combineNew.itemsCombine.size() == 1) {
                    ...
                    if (manhPhoi != null) {
                        ...
                        String npcSay = "Chế Tạo Phôi Đục Lỗ" + "\n|2|";
                        for (Item.ItemOption io : manhPhoi.itemOptions) {
                            npcSay += io.getOptionString() + "\n";
                        }
                        npcSay += "|7|Bạn có muốn chế tạo Phôi Đục Lỗ" + "\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine) + " vàng \n";
                            buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Chế Tạo\nCần " + player.combineNew.gemCombine + " Ngọc");
...
//        }
        ...
        if (player.combineNew.itemsCombine.size() == 1) {
            ...
            if ((item.isSKHTLLVL0()) && item.isDTL()) {
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    ...
                    InventoryServiceNew.gI().sendItemBags(player);
                    Service.gI().sendThongBaoOK(player, "Bạn Nhận Được Đá Nâng SKH Vip");
                    InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
                    player.combineNew.itemsCombine.clear();
                    InventoryServiceNew.gI().sendItemBags(player);
                    Service.gI().sendMoney(player);
    ...
    private void phanradothanlinhx1(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            ...
            Service.gI().sendThongBaoOK(player, "Bạn Nhận Được Đá Nâng SKH");
            InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
            player.combineNew.itemsCombine.clear();
            InventoryServiceNew.gI().sendItemBags(player);
            Service.gI().sendMoney(player);
    ...
    private void phanradothanlinhx3(Player player) {
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            Item item1 = player.combineNew.itemsCombine.get(1);
            Item item2 = player.combineNew.itemsCombine.get(2);
            if (item.isDTL() && item1.isDTL() && item2.isDTL()) {
                int couponAdd = itemdov2.stream().anyMatch(t -> t == item.template.id) ? 1
                        : item.template.id == 561 ? 1 : 1;
                sendEffectSuccessCombine(player);
                ...
                Service.gI().sendThongBaoOK(player, "Bạn Nhận Được 3 Đá Nâng SKH");
                InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
    ...
    private void phanradothanlinhx5(Player player) {
        if (player.combineNew.itemsCombine.size() == 5) {
            ...
            Item item3 = player.combineNew.itemsCombine.get(3);
            Item item4 = player.combineNew.itemsCombine.get(4);
            if (item.isDTL() && item1.isDTL() && item2.isDTL() && item3.isDTL() && item4.isDTL()) {
                int couponAdd = itemdov2.stream().anyMatch(t -> t == item.template.id) ? 1
                        : item.template.id == 561 ? 1 : 1;
                sendEffectSuccessCombine(player);
                ...
                Service.gI().sendThongBaoOK(player, "Bạn Nhận Được 5 Đá Nâng SKH");
                InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
                InventoryServiceNew.gI().subQuantityItemsBag(player, item1, 1);
                InventoryServiceNew.gI().subQuantityItemsBag(player, item2, 1);
    ...
    public void nangcapskhlvl1(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            Item item1 = player.combineNew.itemsCombine.get(0);
            Item item7 = player.combineNew.itemsCombine.get(1);
            if ((item1.isSKH() && item7.isDNS())) {
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    ...
                    if (Util.isTrue(tile, 100)) {
                        ...
                        if (item != null) {
                            ...
                            Service.getInstance().sendThongBao(player, "Bạn đã nhận được " + item.template.name);
                            InventoryServiceNew.gI().subQuantityItemsBag(player, item1, 1);
                            InventoryServiceNew.gI().subQuantityItemsBag(player, item7, 3);
                            InventoryServiceNew.gI().sendItemBags(player);
                        }
                    } else {
                        InventoryServiceNew.gI().subQuantityItemsBag(player, item7, 3);
                ...
                Service.getInstance().sendThongBao(player, "Thiếu nguyến liệu");
            }
        }
    }
    ...
    public void nangcapskhlvl2(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            Item item1 = player.combineNew.itemsCombine.get(0);
            Item item7 = player.combineNew.itemsCombine.get(1);
            if ((item1.isSKHLVL1() && item7.isDNS())) {
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    ...
                    if (Util.isTrue(tile, 100)) {
                        ...
                        if (item != null) {
                            ...
                            Service.getInstance().sendThongBao(player, "Bạn đã nhận được " + item.template.name);
                            InventoryServiceNew.gI().subQuantityItemsBag(player, item1, 1);
                            InventoryServiceNew.gI().subQuantityItemsBag(player, item7, 5);
                            InventoryServiceNew.gI().sendItemBags(player);
                        }
                    } else {
                        InventoryServiceNew.gI().subQuantityItemsBag(player, item7, 5);
    ...
    private void phaLeHoaTrangBi8s(Player player) {
        if (!player.combineNew.itemsCombine.isEmpty() && player.combineNew.itemsCombine.size() < 4) {
            ...
            if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.template.id == 1504 && item.quantity >= 3).count() != 1) {
                Service.getInstance().sendThongBao(player, "Thiếu Phôi Đục Lỗ");
                return;
            }
...
//                        }
                    ...
                    if (Util.isTrue(player.combineNew.TileNangcap, 100)) {
                        ...
                        switch (capbac) {
                            ...
                            case 5:
                                chanmenh.template = ItemService.gI().getTemplate(chanmenh.template.id + 1);
                                chanmenh.itemOptions.clear();
                                chanmenh.itemOptions.add(new Item.ItemOption(50, 9));
                                chanmenh.itemOptions.add(new Item.ItemOption(77, 9));
                                chanmenh.itemOptions.add(new Item.ItemOption(103, 9));
                                chanmenh.itemOptions.add(new Item.ItemOption(30, 1));
                                break;
                            case 6:
                                chanmenh.template = ItemService.gI().getTemplate(chanmenh.template.id + 1);
                                chanmenh.itemOptions.clear();
                                chanmenh.itemOptions.add(new Item.ItemOption(50, 11));
                                chanmenh.itemOptions.add(new Item.ItemOption(77, 11));
                                chanmenh.itemOptions.add(new Item.ItemOption(103, 11));
                                chanmenh.itemOptions.add(new Item.ItemOption(30, 1));
                                break;
                            case 7:
                                chanmenh.template = ItemService.gI().getTemplate(chanmenh.template.id + 1);
                                chanmenh.itemOptions.clear();
                                chanmenh.itemOptions.add(new Item.ItemOption(50, 13));
                                chanmenh.itemOptions.add(new Item.ItemOption(77, 13));
                                chanmenh.itemOptions.add(new Item.ItemOption(103, 13));
                                chanmenh.itemOptions.add(new Item.ItemOption(30, 1));
                                break;
                            case 8:
                                chanmenh.template = ItemService.gI().getTemplate(chanmenh.template.id + 1);
                    ...
                    while (menu > 0) {
                        ...
                        if (Util.isTrue((player.nPoint.hpg >= 600000 && player.nPoint.hpg < 625000
                                ...
                                && player.nPoint.dameg >= 32000 && player.nPoint.dameg < 33000 ? 30
                                        : player.nPoint.hpg >= 625000 && player.nPoint.hpg < 650000
                                        && player.nPoint.mpg >= 625000 && player.nPoint.mpg < 650000
                                        && player.nPoint.dameg >= 33000 && player.nPoint.dameg < 34500 ? 100 : 100), 100)) {
                    ...
                    while (menu > 0) {
                        ...
                        String tsSay = "|7|[ THỨC TỈNH ĐỆ TỬ ]\n" + player.pet.name.substring(1)
                                ...
                                && player.pet.nPoint.dameg >= 32000 && player.pet.nPoint.dameg < 33000 ? "50%"
                                        : player.pet.nPoint.hpg >= 625000 && player.pet.nPoint.hpg < 650000
                                        && player.pet.nPoint.mpg >= 625000 && player.pet.nPoint.mpg < 650000
                                        && player.pet.nPoint.dameg >= 33000 && player.pet.nPoint.dameg < 34500 ? "100%" : "100%") + "\n";
                        this.buhan.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, tsSay,
                                "Nâng X1\nCần 100\nHồng Ngọc", "Nâng X10\nCần 1.000\nHồng Ngọc", "Nâng X100\nCần 10.000\nHồng Ngọc");
                        if (Util.isTrue((player.pet.nPoint.hpg >= 600000 && player.pet.nPoint.hpg < 625000
                                ...
                                && player.pet.nPoint.dameg >= 32000 && player.pet.nPoint.dameg < 33000 ? 50
                                        : player.pet.nPoint.hpg >= 625000 && player.pet.nPoint.hpg < 650000
                                        && player.pet.nPoint.mpg >= 625000 && player.pet.nPoint.mpg < 650000
                                        && player.pet.nPoint.dameg >= 33000 && player.pet.nPoint.dameg < 34500 ? 100 : 100), 100)) {
                            player.inventory.ruby -= 100;
    ...
    public void KhamNgocBoi(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            int gold = player.combineNew.goldCombine;
            if (player.inventory.gold < gold) {
                Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện");
            ...
            if (ngocBoi != null && daKham != null && daKham.quantity >= 1) {
                player.inventory.gold -= gold;
                player.inventory.gem -= gem;
                InventoryServiceNew.gI().subQuantityItemsBag(player, daKham, 1);
                if (ngocBoi.template.id == 1409) {
                    ngocBoi.itemOptions.clear();
                    switch (daKham.template.id) {
                        case 1600:
                            ngocBoi.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 5)));
                            break;
                        case 1601:
                            ngocBoi.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 5)));
                            break;
                        case 1602:
                            ngocBoi.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 5)));
                            break;
                    }
                    sendEffectSuccessCombine(player);
                } else if (ngocBoi.template.id == 1410) {
                    ngocBoi.itemOptions.clear();
                    switch (daKham.template.id) {
                        case 1600:
                            ngocBoi.itemOptions.add(new Item.ItemOption(77, Util.nextInt(5, 10)));
                            break;
                        case 1601:
                            ngocBoi.itemOptions.add(new Item.ItemOption(103, Util.nextInt(5, 10)));
                            break;
                        case 1602:
                            ngocBoi.itemOptions.add(new Item.ItemOption(50, Util.nextInt(5, 10)));
                            break;
                    }
                    sendEffectSuccessCombine(player);
                }
    ...
    public void KichAn(Player player) {
        if (player.combineNew.itemsCombine.size() == 3) {
            int gold = player.combineNew.goldCombine;
            if (player.inventory.gold < gold) {
                Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện");
            ...
            if (trangBi != null && sachCo != null && sachCo.quantity >= 1 && an != null && an.quantity >= 1) {
                player.inventory.gold -= gold;
                player.inventory.gem -= gem;
                InventoryServiceNew.gI().subQuantityItemsBag(player, sachCo, 1);
                InventoryServiceNew.gI().subQuantityItemsBag(player, an, 1);
                if (Util.isTrue(RATIO_KICH_AN, 100)) {
                    switch (an.template.id) {
                        case 1604:
                            trangBi.itemOptions.add(new Item.ItemOption(233, 0));
                            break;
                        case 1605:
                            trangBi.itemOptions.add(new Item.ItemOption(234, 0));
                            break;
                        case 1606:
                            trangBi.itemOptions.add(new Item.ItemOption(235, 0));
                            break;
                    }
                    sendEffectSuccessCombine(player);
                } else {
    ...
    public void DoiAnMoc(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            Item an = null;
            for (Item item : player.combineNew.itemsCombine) {
                if (item.template.id == 1604 || item.template.id == 1605 || item.template.id == 1606) {
            ...
            if (an != null && an.quantity >= 2) {
                InventoryServiceNew.gI().subQuantityItemsBag(player, an, 2);
                Item anMoc = ItemService.gI().createNewItem((short) 1604, 1);
                InventoryServiceNew.gI().addItemBag(player, anMoc);
                InventoryServiceNew.gI().sendItemBags(player);
                sendEffectSuccessCombine(player);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendMoney(player);
    ...
    public void DoiAnThuy(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            Item an = null;
            for (Item item : player.combineNew.itemsCombine) {
                if (item.template.id == 1604 || item.template.id == 1605 || item.template.id == 1606) {
            ...
            if (an != null && an.quantity >= 2) {
                InventoryServiceNew.gI().subQuantityItemsBag(player, an, 2);
                Item anMoc = ItemService.gI().createNewItem((short) 1605, 1);
                InventoryServiceNew.gI().addItemBag(player, anMoc);
                InventoryServiceNew.gI().sendItemBags(player);
                sendEffectSuccessCombine(player);
                InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void DoiAnHoa(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            Item an = null;
            for (Item item : player.combineNew.itemsCombine) {
                if (item.template.id == 1604 || item.template.id == 1605 || item.template.id == 1606) {
            ...
            if (an != null && an.quantity >= 2) {
                InventoryServiceNew.gI().subQuantityItemsBag(player, an, 2);
                Item anMoc = ItemService.gI().createNewItem((short) 1606, 1);
                InventoryServiceNew.gI().addItemBag(player, anMoc);
                InventoryServiceNew.gI().sendItemBags(player);
                sendEffectSuccessCombine(player);
                InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void NangCuonSach(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            int gold = player.combineNew.goldCombine;
            if (player.inventory.gold < gold) {
                Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện");
            ...
            if (cuonSach != null && sachCu != null && sachCu.quantity >= 1) {
                player.inventory.gold -= gold;
                player.inventory.gem -= gem;
                switch (cuonSach.template.id) {
                    case 1459:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1460, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(2, 5)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(2, 5)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(2, 5)));
                        break;
                    case 1460:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1461, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(5, 8)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(5, 8)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(5, 8)));
                        break;
                    case 1461:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1462, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(8, 11)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(8, 11)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(8, 11)));
                        break;
                    case 1462:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1464, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(11, 14)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(11, 14)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(11, 14)));
                        break;
                    case 1464:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1476, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(14, 17)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(14, 17)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(14, 17)));
                        break;
                    case 1476:
                        cuonSachNew = ItemService.gI().createNewItem((short) 1480, 1);
                        cuonSachNew.itemOptions.add(new Item.ItemOption(77, Util.nextInt(17, 20)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(103, Util.nextInt(17, 20)));
                        cuonSachNew.itemOptions.add(new Item.ItemOption(50, Util.nextInt(17, 20)));
                        break;
                }
                InventoryServiceNew.gI().subQuantityItemsBag(player, sachCu, 1);
                InventoryServiceNew.gI().subQuantityItemsBag(player, cuonSach, 1);
                InventoryServiceNew.gI().addItemBag(player, cuonSachNew);
                sendEffectSuccessCombine(player);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendMoney(player);
                reOpenItemCombine(player);
    ...
    public void CheTaoPhoi(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            int gold = player.combineNew.goldCombine;
            if (player.inventory.gold < gold) {
                Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện");
            ...
            if (manhPhoi != null && manhPhoi.quantity >= 5) {
                player.inventory.gold -= gold;
                player.inventory.gem -= gem;

                Item phoiDucLo = ItemService.gI().createNewItem((short) 1504, 1);

                InventoryServiceNew.gI().subQuantityItemsBag(player, manhPhoi, 5);
                InventoryServiceNew.gI().addItemBag(player, phoiDucLo);
                sendEffectSuccessCombine(player);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendMoney(player);
                reOpenItemCombine(player);
    ...
    private String getTextTopTabCombine(int type) {
        switch (type) {
            ...
            case KHAM_NGOC_BOI:
                return "Ta sẽ giúp ngươi Khảm Ngọc Bội\nGiúp gia tăng chỉ số cao hơn";
            case KICH_AN:
                return "Ta sẽ giúp ngươi Mở Phong Ấn\nGiúp gia tăng chỉ số cao hơn";
            case DOI_AN:
        ...
        switch (type) {
            ...
            case NANG_SKH_LVL1:
                return "Vào hành trang\n"
                        ...
                        + "x3 đá nâng SKH để cuối\n"
                        + "Sau đó chọn 'Nâng cấp'\n"
                        + "Tỉ lệ thành công là 50%\n"
                        + "Nâng cấp thất bại sẽ mất đá nâng cấp\n"
                        + "Lưu ý: Sao pha lê và Ấn trang bị sẽ mất khi nâng thành công";
            case NANG_SKH_LVL2:
                return "Vào hành trang\n"
                        + "Chọn 1 trang bị SKH thường [Level 1]\n"
                        + "Món đầu tiên sẽ là món được nâng cấp\n"
                        + "x5 đá nâng SKH để cuối\n"
                        + "Sau đó chọn 'Nâng cấp'\n"
                        + "Tỉ lệ thành công là 50%\n"
                        + "Nâng cấp thất bại sẽ mất đá nâng cấp\n"
                        + "Lưu ý: Sao pha lê và Ấn trang bị sẽ mất khi nâng thành công";
            ...
            case NANG_CAP_VAT_PHAM:
                return "vào hành trang\nChọn trang bị\n(Áo, quần, găng, giày hoặc rađa)\nChọn loại đá để nâng cấp\n"
                        + "Sau đó chọn 'Nâng cấp'";
            case PHAN_RA_DO_THAN_LINH:
                return "Vào hành trang\nChọn item\n(Đồ Thần)\nChọn Đồ Thần Muốn Tách\n"
                        + "Sau đó chọn 'Tách'";

            case PHAN_RA_DO_THAN_LINH_X3:
                return "Vào hành trang\nChọn 3 item\n(Đồ Thần)\nChọn 3 Đồ Thần Muốn Tách\n"
                        + "Sau đó chọn 'Tách'";
            case PHAN_RA_DO_THAN_LINH_X5:
                return "Vào hành trang\nChọn 5 item\n(Đồ Thần)\nChọn 5 Đồ Thần Muốn Tách\n"
                        + "Sau đó chọn 'Tách'";
            case NANG_CAP_DO_TS:
            ...
            case NANG_CAP_BONG_TAI_2_LEN_3:
                return "Vào Hành Trang\nChọn Bông Tai Porata Cấp 2\nVà x999 Mảnh Vỡ Bông Tai Cấp 3\nSau Đó Chọn 'Nâng Cấp'";
            case MO_CHI_SO_BONG_TAI_CAP3:
                return "Vào Hành Trang\nChọn Bông Tai Porata Cấp 3\nChọn Thạch Phù x99\nVà Đá Xanh Lam Để Nâng Cấp\nSau Đó Chọn 'Nâng Cấp'";
            case NANG_CAP_BONG_TAI_3_LEN_4:
                return "Vào Hành Trang\nchọn Bông Tai Porata Cấp 3\nVà x999 Mảnh Vỡ Bông Tai Cấp 4\nSau Đó Chọn 'Nâng Cấp'";
            case MO_CHI_SO_BONG_TAI_CAP4:
                return "Vào Hành Trang\nChọn Bông Tai Porata Cấp 4\nChọn Thạch Phù x99 \nVà Đá Xanh Lam x5\nSau Đó Chọn 'Nâng Cấp'";
            case NANG_CAP_BONG_TAI_CAP5:
                return "Vào hành trang\nchọn Bông Tai Porata Cấp 4\nVà x999 Mảnh Vỡ Bông Tai Cấp 5\nSau Đó Chọn 'Nâng Cấp'";
            case MO_CHI_SO_BONG_TAI_CAP5:
            ...
            case THUC_TINH_DT:
                return "Nguyên liệu cần có:\n\n"
                        ...
                        + "[Đối với Sư Phụ]\nx20 Đá Thức Tỉnh\nx1 Ngọc Rồng 1 Sao\nx3 Thỏi Vàng\n"
                        + "Nếu thất bại sẽ chỉ mất đá thức tỉnh\n\n"
            ...
            case THUC_TINH_SP:
                return "Nguyên liệu cần có: \nĐá Thức Tỉnh x50\nNgọc Rồng 1 Sao x3\nThỏi Vàng x5\n"
                        ...
                        + "Sau đó chọn 'Nâng cấp'\n";
            case KHAM_NGOC_BOI:
                return "Vào hành trang\nChọn Ngọc Bội\nChọn Đá Khảm Ngọc Bội\nSau đó chọn 'Khảm Ngọc Bội'";
            case KICH_AN:
                return "Vào hành trang\nChọn 1 Trang Bị (Áo, Quần, Găng, Giày)\nChọn Sách Cổ\nChọn 1 Ấn muốn mở\nSau đó chọn 'Khai Mở Phong Ấn'";
            case DOI_AN:
                return "Vào hành trang\nChọn Ấn bất kì\nLưu ý: Đổi sang Ấn mới sẽ tiêu hao 2 Ấn cũ\n";
            case SACH_TUYET_KI:
                return "Vào hành trang\nChọn 1 Cuốn Sách và 1 Sách Cũ\nSau khi nâng cấp nhận được\nCuốn Sách cao cấp hơn\n Với chỉ số ngẫu nhiên";
            case CHE_TAO_PHOI:
                return "Vào hành trang\nChọn 5 Mảnh Vỡ Phôi\nSau khi chế tạo nhận được\nPhôi Đục Lỗ";
            default:
                return "";
        }
    }
