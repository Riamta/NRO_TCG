...
public class TradeService {
       ...
       if (pl.getSession() != null && pl.vip <0){
        ...
        if (this.player2.getSession().actived!=1&& pl.getSession().player.nPoint.power < 10000000000L) {
            ...
            Service.gI().sendThongBaoFromAdmin(pl,
                  "|5|Đối phương chưa mở thành viên và đạt đủ 10 tỷ không thể giao dịch!");
        ...
        if (true) {
           ...
           this.cancelTrade();
            Service.gI().sendThongBaoFromAdmin(pl,
                  "|5|Bạn chưa mở thành viên và đạt đủ 10 tỷ không thể giao dịch!");
            removeItemTrade(pl, index);
    }
    }
    ...
    public List<Item> itemsTradeBot(){
       return itemsTrade1;
    }
