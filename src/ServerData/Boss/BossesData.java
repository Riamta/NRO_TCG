...
public class BossesData {
    ...
    public static final BossData ANDROID_13 = new BossData(
            ...
            REST_15_M,
            new int[]{BossID.ANDROID_14, BossID.ANDROID_15}
    );
...
//**************************************************************************
    ...
    public static final BossData ANTROM = new BossData(
            ...
            new int[][]{
                    {Skill.THAI_DUONG_HA_SAN, 3, 10000},
            },//skill
            new String[]{}, //text chat 1
            new String[]{},
    ...
    public static final BossData SU_PHU = new BossData(
            "Sư Phụ", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{89, 90, 91, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1, //dame
            new long[]{1000}, //hp
            new int[]{0, 1, 2, 3, 4, 5, 6}, //map join
            new int[][]{
