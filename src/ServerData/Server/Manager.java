...
public class Manager {
    ...
    public static int TLDOIXUVANG = 1;
    public static int TLDOITHANGTINHTHACH = 2;
    // *** //
    ...
    public static final byte[] itemIds_NR_SB = {16, 17, 18, 19, 20};
                ...
                if (!fileEntry.isDirectory()) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (item.getTemp().type < 5) {
                            item.setRatio(new int[]{Integer.parseInt(ratio[0]), Integer.parseInt(ratio[1]) / 4 * 4});
                        }
