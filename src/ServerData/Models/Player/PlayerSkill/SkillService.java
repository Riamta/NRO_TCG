...
import ServerData.Models.Player.EffectSkill;
        ...
        switch (player.playerSkill.skillSelect.template.id) {
            ...
            case Skill.BIEN_HINH:
                ...
                if (player.effectSkill.levelBienHinh < player.playerSkill.skillSelect.point) {
                    ...
                    PlayerService.gI().sendInfoHpMp(player);
                    // ICON Ở GÓC TD / NM/XD
                    ItemTimeService.gI().sendItemTime(player, 31142, player.effectSkill.timeBienHinh / 3000);
                    affterUseSkill(player, player.playerSkill.skillSelect.template.id);
                }
                break;
...
//                    }
                    ...
                    try {
                        ...
                        affterUseSkill(player, player.playerSkill.skillSelect.template.id);
                        player.injured(null, 5000000000L, true, false);
                        if (player.effectSkill.tiLeHPHuytSao != 0 || player.effectSkill.timeMonkey != 0 || player.effectSkill.timeBienHinh != 0) {
                            player.effectSkill.tiLeHPHuytSao = 0;
                            player.effectSkill.timeMonkey = 0;
                            player.effectSkill.timeBienHinh = 0;
                            ...
                            ItemTimeService.gI().removeItemTime(player, 31142);
                        }
