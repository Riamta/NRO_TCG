...
import ServerData.Models.Map.bandokhobau.BanDoKhoBauService;
                        ...
                        switch (select) {
                            ...
                            case 1:
                                ...
                                if (oldDuongTank != null) {
                                    ...
                                    Service.gI().sendThongBao(player, "Nhà ngươi không đủ 10k hồng ngọc hoặc chưa đạt tới nhiệm vụ 30");
                                } else {

                                    BossData bossDataClone = new BossData(
                                            "Bé rồng đỏ" + " " + player.name + " hộ tống",
                                            (byte) 2,
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                new Thread(() -> {
                    try {
                        while (true) {
                            String[] textLucy = {"|7|Now", "|7|Chào mừng đến với Nro Now !",
                                "|7|NOW!"};
                            Thread.sleep(5000);
                            new Thread(() -> {
                                try {
                ...
                if (canOpenNpc(player)) {
                    ...
                    this.createOtherMenu(player, ConstNpc.BASE_MENU,
                            "Chào mừng đến với NRO RIGHT ! Cậu muốn tìm hiểu gì?",
                            "Sự Kiện", "Vàng", "Hồng Ngọc", "Cơ Chế SKH", "Xu Vàng \nXu Bạc \nThăng Tinh Thạch", "Leo Tháp",
                            "Đệ Tử", "Pha Lê Hóa Trang Bị", "Hợp Thể Gogeta", "Boss Khung Giờ", "Bông Tai", "Đua Top");
                }
                        ...
                        switch (select) {
                            case 0:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Sự Kiện Mùa Hè Đang Diễn Ra \n"
                                        + "Săn All Boss bên Tương Lai Lấy 'Quần Đi Biển' \n"
                                        + "Đeo Quần Đi Biển Và Up Ở Nam Kame Để Lấy Vật Phẩm Sự Kiện \n"
                                        + "Đổi Vật Phẩm Sự Kiện Lấy Các Phần Quà Giá Trị Tại NPC Mị Nương, Đảo Kame");
                                break;
                            case 1:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar, "Khi đánh quái ở tất cả các map có tỉ lệ rơi vàng ngẫu nhiên và cả thỏi vàng, đánh boss tương lai có tỉ lệ rơi ra thỏi vàng, săn boss tích điểm nhận mốc tại Quy Lão Kame");
                                break;
                            case 2:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar, "Đánh boss nhân bản, làm nhiệm vụ bò mộng, up map ngũ hành sơn, điểm danh tại nhà để nhận hồng ngọc miễn phí");
                                break;
                            case 3:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Up SKH thường ở 3 map đầu, có 2 loại SKH ( Thường - Thần Linh ), mỗi loại chia ra 3 level, mỗi level sẽ có 1 nội tại riêng, khi mặc đủ 5 món sẽ hiện danh hiệu đặc quyền \n"
                                        + "Đá Nâng SKH Thường phân rã đồ thần tại Bà Hạt Mít \n"
                                        + "Đá Nâng SKH Thần Linh ghép từ Đá Nâng SKH Thường ở Bà Hạt Mít tại Đảo Kame");
                                break;
                            case 4:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Xu Vàng săn Boss Hủy Diệt ở Hành Tinh Beerus, gặp Whis ở làng Aru để tới \n"
                                        + "Xu Bạc đánh quái tất cả các map đều có tỉ lệ rơi \n"
                                        + "Thăng Tinh Thạch săn Boss Hành Tinh Ngục Tù có tỉ lệ rơi");
                                break;
                            case 5:
                            ...
                            case 6:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Có 6 loại đệ tử, 3 loại ở Shop, 3 loại săn Super Broly, 3 loại ở shop là Cumber (30% chỉ số), Vegeta SSJ4 (50% chỉ số), Goku SSJ4 (50% chỉ số)\n"
                                        + " Đệ săn từ Super Broly gồm Mabu Mập (20%), ra đảo kame Thức Tỉnh đệ Mabu Mập có tỉ lệ ra 2 đệ sau: Bư Han(25%), Bư Gầy (45%) \n"
                                        + "Đá Thức Tỉnh nhận ở các Mốc Săn Boss hoặc đánh Boss Mabu xuất hiện ở Đại Hội Võ Thuật");
                                break;
                            case 7:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Gặp Bà Hạt Mít ở đảo Kame để đục lỗ trang bị \n"
                                        + "Pha Lê Hóa Thường tối đa 7 sao pha lê \n"
                                        + "Pha Lê Hóa Vip cần Dùi Đục và Phôi Đục Lỗ, có tỉ lệ lên 8 sao pha lê \n"
                                        + "Dùi Đục dùng Xu Bạc để đổi tại Satan, Phôi Đục Lỗ săn Đám Boss Doremon và Boss Hành Tinh Ngục Tù"
                                );
                                break;
                            case 8:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar, "Hợp thể GOGETA khi sử dụng bông tai phải đủ điều kiện sau:\n - Có đệ Vegeta SSJ4 hoặc Goku SSJ4\n - Sư phụ phải mặc cải trang SSJ4\n - Chỉ số sau khi hợp thể Gogeta tăng 20%");
                                break;
                            case 9:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Nhiệm vụ Kuku, Rambo, Mập Đầu Đinh và Nhiệm vụ TĐST được hỗ trợ vào 12H đến 13H, 18H đến 19H"
                                );
                                break;
                            case 10:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Có 4 cấp bông tai từ 1 đến 4, vật phẩm để nâng cấp và mở chỉ số bông tai up tại Map Lãnh Địa Bang ở Quy Lão Kame tại đảo Kame"
                                );
                                break;
                            case 11:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Sever đang trong quá trình đua top Sức Mạnh và Nhiệm Vụ, bạn có thể xem Bảng Xếp Hạng tại NPC Vados ở Đảo Kame hoặc trên Web"
                                );
                                break;
                            default:
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, 1234, "|7|- •⊹٭DragonBall Right٭⊹• -\n|2|MÁY GẮP PET HAY, LINH THÚ\nGẮP THƯỜNG : 1 XU/LƯỢT\nGẮP CAO CẤP : 3 XU/LƯỢT\nGẮP VIP : 5 XU/LƯỢT\n"
                                ...
                                "Gắp Thường", "Gắp Cao Cấp", "Gắp VIP", "Rương Đồ");
                    }
                }
            }
                ...
                if (canOpenNpc(pl)) {
                    switch (select) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            if (pl.name != ConstNpc.NAME){
                                Service.gI().showMenuu(pl);
                            }
...
//                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Nhận quà\nđền bù");
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, Ta có thể giúp gì cho con",
                                    "Kho Báu\nDưới Biển", "Chức Năng\nBang Hội", "Nhận Quà\nTích Luỹ", "Đóng");
                        }
                    }
                }
...
//                                break;
                            case 2:
                                createOtherMenu(player, 0,
                                        ...
                                        "Hiện tại con đang có: " + player.pointSb + " Điểm Săn Boss"
...
//                                        "Đưa ta 10 thỏi vàng để hồi skill cấp tốc",
//                                        "Dạ", "Không");
//                                break;
...
//                                        && InventoryServiceNew.gI().findItemBag(player, 457).quantity >= 10) {
//                                    InventoryServiceNew.gI().subQuantityItemsBag(player,
//                                            InventoryServiceNew.gI().findItemBag(player, 457), 10);
//                                    InventoryServiceNew.gI().sendItemBags(player);
//                                    int subTimeParam=80;
...
//                                    return;
//                                } else {
//                                    Service.gI().sendThongBaoOK(player, "Con không có đủ tiền");
//
//                                }
                                break;
                    ...
                    } else if (player.iDMark.getIndexMenu() == 1) { // Mốc nạp
                        switch (select) {
                            case 0:
                                createOtherMenu(player, 2,
                                        ...
                                        + "\n|2|- 100 Thỏi Vàng"
                                        + "\n- 10 Máy Dò Boss"
                                        + "\n- 5 Hộp Đồ Kích Hoạt Thường (Random)"
                                        + "\n- 5 Vé Ngũ Hành Sơn"
                            ...
                            case 5:
                                createOtherMenu(player, 2,
                                        ...
                                        + "\n- Danh Hiệu Đại Gia Mới Nhú (15% all chỉ số)"
                                        + "\n- 100 Phôi Đục Lỗ"
                                        + "\n- 50 Máy Dò Boss"
                                        + "\n- 30 Vé Ngũ Hành Sơn"
                                        + "\n|7| Bạn có mún nhận khum?",
                    ...
                    } else if (player.iDMark.getIndexMenu() == 3) { // Mốc săn boss
                        switch (select) {
                            case 0:
                    ...
                    } else if (player.iDMark.getIndexMenu() == 2) { // Nhận mốc nạp
                        switch (select) {
                            case 0:
                                UseItem.gI().ComfirmMocNap(player);
                                break;
                        }
                    } else if (player.iDMark.getIndexMenu() == 4) { // Nhận mốc săn boss
                        switch (select) {
                            case 0:
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (player.zone.map.mapId == 13) {
                            ...
                            String npcSay = "Chào con, con cần ta giúp gì?\nTa có thể nâng giới hạn vàng cho con. Mỗi lần nâng tốn 500Tr vàng và giới hạn vàng của con sẽ tăng lên 1 bậc";
                            String[] menu = {
                                "Mở Giới\nHạn Vàng", "Đóng"
                            };
...
//                                } else {
//                                    this.npcChat(player, "Hôm nay con đã nhận rồi");
//                                }
//                                break;
                            case 0:
                            if (player.diemdanh == 1){
...
//                                break;
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().vnd >= 40000) {
                                    ...
                                    PlayerDAO.subvndmua(player, 40000);
                                    Service.gI().sendMoney(player);
                                    this.npcChat(player, "|6|Đã mở thành công\n|7|VIP1");
                                    Item danhhieu = ItemService.gI().createNewDanhHieu((short) 1459, 4, 4, 4);
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().vnd >= 60000) {
                                    player.vip = 2;
                                    player.timevip = (System.currentTimeMillis() + (1000 * 60 * 60 * 24 * 15)) + (1000 * 60 * 60 * 24 * 16);
                                    PlayerDAO.subvndmua(player, 60000);
                                    Service.gI().sendMoney(player);
                                    this.npcChat(player, "|6|Đã mở thành công\n|7|VIP2");
                                    Item danhhieu = ItemService.gI().createNewDanhHieu((short) 1460, 6, 6, 6);
                                    InventoryServiceNew.gI().addItemBag(player, danhhieu);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                } else {
                                    this.npcChat(player, "Bạn không đủ tiền");
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().vnd >= 80000) {
                                    player.vip = 3;
                                    player.timevip = (System.currentTimeMillis() + (1000 * 60 * 60 * 24 * 15)) + (1000 * 60 * 60 * 24 * 16);
                                    PlayerDAO.subvndmua(player, 80000);
                                    Service.gI().sendMoney(player);
                                    this.npcChat(player, "|6|Đã mở thành công\n|7|VIP3");
                                    Item danhhieu = ItemService.gI().createNewDanhHieu((short) 1461, 8, 8, 8);
                                    InventoryServiceNew.gI().addItemBag(player, danhhieu);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                } else {
                                    this.npcChat(player, "Bạn không đủ tiền");
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().vnd >= 100000) {
                                    ...
                                    Service.gI().sendMoney(player);
                                    this.npcChat(player, "|6|Đã mở thành công\n|7|SVIP");
                                    Item danhhieu = ItemService.gI().createNewDanhHieu((short) 1462, 10, 10, 10);
                                    InventoryServiceNew.gI().addItemBag(player, danhhieu);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                } else {
                                    this.npcChat(player, "Bạn không đủ tiền");
                        ...
                        switch (select) {
                            case 0:
                                ...
                                break;
                            case 1:
                                this.npcChat(player, "Cảm ơn con nhé!!!");
                                break;
                        }
                    }
                }
                        ...
                        switch (select) {
                            case 0://Shop
                                if (player.gender == ConstPlayer.NAMEC) {
                                    ...
                                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Xin lỗi anh, em chỉ bán đồ cho dân tộc Namec", "Đóng");
                                }
                                break;
                        }
                    } else if (player.iDMark.getIndexMenu() == 1) {
...
//                                SummonDragon.gI().summonNamec(player);
                                ...
                                Service.gI().sendThongBao(player, "Anh phải có viên ngọc rồng Namec 1 sao");
                            }
                        }
                    }
                }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5: // shop sách
                                    ShopServiceNew.gI().opendShop(player, "SANTA_SACH", true);
                                    break;
                            }
                        }
                    }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        switch (ConstEvent.EVENT) {
                            case 1:
                                this.createOtherMenu(player, ConstEvent.MUAHE, "|7|-Sự Kiện Mùa Hè-\n"
                                ...
                                switch (select) {
                                    case 0:
                                        ...
                                        if (SaoBien == null || SaoBien.quantity < 999) {
                                            ...
                                            Service.gI().sendMoney(player);
                                            Item danhhieu = ItemService.gI().createNewItem((short) (1453));
                                            ...
                                            danhhieu.itemOptions.add(new Item.ItemOption(207, 0));
                                            if (Util.isTrue(999, 1000)) {
                                                danhhieu.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 7)));
                                            }
                                            InventoryServiceNew.gI().addItemBag(player, danhhieu);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            this.npcChat(player, "Bạn nhận được Danh Hiệu Tuổi Thơ");
                                        }
                                        break;
                                    case 1:
                                        Item ConCua = null;
...
//                                            Service.gI().sendMoney(player);
//                                            Item caitrang = ItemService.gI().createNewItem((short) (945));
//                                            caitrang.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15,25)));
//                                            caitrang.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15,25)));
//                                            caitrang.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15,25)));
//                                            caitrang.itemOptions.add(new Item.ItemOption(101, Util.nextInt(50,100)));
//                                            caitrang.itemOptions.add(new Item.ItemOption(207, 0));
//                                            caitrang.itemOptions.add(new Item.ItemOption(30, 0));
//                                            if (Util.isTrue(999, 1000)){
//                                                caitrang.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3,7)));
//                                            }
...
//                                            this.npcChat(player, "Bạn nhận được Cải Trang Sự Kiện");
                                            ...
                                            Service.gI().sendMoney(player);
                                            Item daskhthuong = ItemService.gI().createNewItem((short) 1525, 1);
                                            daskhthuong.itemOptions.add(new Item.ItemOption(30, 0));
                                            InventoryServiceNew.gI().addItemBag(player, daskhthuong);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            this.npcChat(player, "Bạn nhận được Đột Phá Sức Mạnh Trái Đất");
                                        }
                                        break;
                                    case 2:
                                        Item VoSo = null;
                                        ...
                                        if (VoSo == null || VoSo.quantity < 99) {
                                            ...
                                            Service.gI().sendMoney(player);
                                            Item daskhthuong = ItemService.gI().createNewItem((short) 1526, 1);
                                            daskhthuong.itemOptions.add(new Item.ItemOption(30, 0));
                                            InventoryServiceNew.gI().addItemBag(player, daskhthuong);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            this.npcChat(player, "Bạn nhận được Đột Phá Sức Mạnh Xayda");
                                        }
                                        break;
                                    case 3:
                                        Item VoOc = null;
                                        ...
                                        if (VoOc == null || VoOc.quantity < 99) {
                                            ...
                                            Item dahomet = ItemService.gI().createNewItem((short) 1527, 1);
                                            dahomet.itemOptions.add(new Item.ItemOption(30, 0));
                                            InventoryServiceNew.gI().subQuantityItemsBag(player, VoOc, 99);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            InventoryServiceNew.gI().addItemBag(player, dahomet);
                                            this.npcChat(player, "Bạn nhận được Đột Phá Sức Mạnh Namec");
                                        }
                                        break;
                                }
                                break;
                        ...
                        switch (player.iDMark.getIndexMenu()) {
                            case 0:
                                if (player.BanhChung == 0 && player.BanhTet == 0) {
                                    Service.gI().sendThongBao(player, "Bạn chưa nấu bánh");
                                    return;
                                }
                                ...
                                switch (select) {
                                    case 0:
                                        if (nuocNau == null || nuocNau.quantity < 1) {
                                            Service.gI().sendThongBao(player, "Chưa có nước");
                                            return;
                                        }
                                        if (NauBanh.Nuoc < 500) {
                                ...
                                switch (select) {
                                    case 0:
                                        if (cuiLua == null || cuiLua.quantity < 1) {
                                            Service.gI().sendThongBao(player, "Chưa có củi");
                                            return;
                                        }
                                        if (NauBanh.Cui < 500) {
                                            ...
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            NauBanh.Cui++;
                                            Service.gI().sendThongBao(player, "Đã thêm củi");
                                        } else {
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    createOtherMenu(player, ConstNpc.MENU_PHA_LE_HOA_VIP,
                                            "Ngươi muốn pha lê hóa 8 sao phải không\n",
                                            "Đồng ý", "Hướng Dẫn");
                                    break;
                                case 3: // nâng cấp skh thường
                                    createOtherMenu(player, ConstNpc.MENU_NANG_SKH_LVL,
                                            "Ngươi tìm ta có việc gì?\n",
                                            "Nâng\nSKH [LVL0]", "Nâng\nSKH [LVL1]", "Nâng\nSKH [LVL2]", "Hướng Dẫn");
                                    break;
                                case 4:
                                    createOtherMenu(player, ConstNpc.MENU_CHAN_MENH,
                                            "Ngươi muốn nâng cấp Chân Mệnh phải không\n",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                                case 5:
                                    createOtherMenu(player, ConstNpc.MENU_PHAN_RA,
                                            "Ngươi tìm ta có việc gì?\n",
                                            "Đồ Thần X1", "Đồ Thần X3", "Đồ Thần X5", "Hướng Dẫn");
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_CHAN_MENH) {
                            switch (select) {
                                case 0:
                                ...
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần Chân Mệnh và Đá Hoàng Kim \n"
                                            + "Đá Hoàng Kim nhận tại mốc săn boss \n"
                                    );
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_PHA_LE_HOA_VIP) {
                            switch (select) {
                                case 0:
                                ...
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Sao Pha Lê 8 sao cần 1 Dùi Đục và 3 Phôi Đục Lỗ \n"
                                            + "Tỉ lệ thành công là 5% \n"
                                            + "Dùi Đục mua tại shop, Phôi Đục Lỗ ghép từ Mảnh Phôi nhận được khi mở rương ĐHVT Lần Thứ 23"
                                    );
                                    break;
                            }
                            ...
                            switch (select) {
                                ...
                                case 3:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Phân rã đồ thần linh nhận được Đá Nâng SKH \n"
                                            + "Phân rã 1 đồ sẽ nhận được 1 Đá Nâng SKh \n"
                                    );
                                    break;
                            ...
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_SKH_THUONG);
                                    break;
                                case 1:
                                ...
                                case 3:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "SKH chia thành 3 level \n"
                                            + "Nâng lên SKH LV0 cần 1 món Đồ Thần Linh \n"
                                            + "Nâng lên SKH LV1 cần SKH lv0 và x3 Đá Nâng SKH \n"
                                            + "Nâng lên SKH LV2 cần SKH lv1 và x5 Đá Nâng SKH \n"
                                            + "Đá Nâng SKH phân rã Đồ Thần Linh để nhận \n"
                                            + "Lưu Ý: Sau khi nâng cấp sẽ mất Sao Pha Lê và Ấn trước đó"
                                    );
                                    break;
                            }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                            ...
                            if (this.mapId == 5 || mapId == 0 || mapId == 7 || mapId == 14) {
                                ...
                                //                                } 
                                    ...
                                    this.createOtherMenu(player, ConstNpc.MENU_NOT_OPEN_TN,
                                            ...
                                            + "[ Khi Map Đóng, Chỉ Những Ai Đang Sử Dụng Vé Mới Có Thể Ở Lại ]", "Đóng");
                                }
                            }
                        } catch (Exception ex) {
                    ...
                    if (mapId == 122 || mapId == 205) {
                        this.createOtherMenu(player, 0, "Bạn Muốn Quay Trở Lại Làng Aru?", "Có", "Từ Chối");

                    }
                    if (mapId == 124 || mapId == 204) {
                            ...
                            if (this.mapId == 5 || this.mapId == 0 || this.mapId == 7 || this.mapId == 14) {
                                switch (player.iDMark.getIndexMenu()) {
                                    case ConstNpc.MENU_OPEN_TN:
                                        if (select == 0) {
                                            ChangeMapService.gI().changeMapInYard(player, 122, -1, 98);
                                        }
                                        break;
//                                    case ConstNpc.MENU_OPEN_TN2:
//                                        if (select == 0) {
//                                            ChangeMapService.gI().changeMapInYard(player, 205, -1, 174);
//                                        }
//                                        break;
                            ...
                            if (mapId == 124 || mapId == 204) {
                                if (select == 0) {
                                    if (player.nhsPoint <= 499) {
                                        ...
                                        item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 20)));// hp
                                        item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 20)));// ki
                                        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(10) + 10));// sd
                                        item.itemOptions.add(new Item.ItemOption(30, 1)); //ko thể gd
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (this.mapId != player.zone.map.mapId) {
                    Service.gI().sendThongBao(player, "Calich đã rời khỏi map!");
                    Service.gI().hideWaitDialog(player);
                    return;
                }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 149) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Ngươi có muốn gọi nhân bản không?", "Gọi Nhân Bản");
                    }
                }
            }
    ...
    public static Npc npcThienSu64(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (this.mapId == 48) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chức năng đang cập nhật",
    ...
    public static Npc gokuSSJ_2(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            "Hãy cố gắng tập luyện" + "\n" + "Thu thập 9999 bí kiếp để đổi Võ phục Yardrat nhé",
                            "Nhận\nThưởng", "Đóng");
                }
            }
                                ...
                                case 0: // trade
                                    if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                        if (player.pointPvp >= 500) {
                                            ...
                                            item.itemOptions.add(new Item.ItemOption(50, 30)); // sd
                                            item.itemOptions.add(new Item.ItemOption(77, 30)); // hp
                                            item.itemOptions.add(new Item.ItemOption(103, 30)); // ki
                                            item.itemOptions.add(new Item.ItemOption(5, 15)); // stcm
                                            item.itemOptions.add(new Item.ItemOption(207, 0));
                                            item.itemOptions.add(new Item.ItemOption(30, 0)); // không thể giao dịch
                                            item.itemOptions.add(new Item.ItemOption(63, 7)); // hsd
//                                      
                                            InventoryServiceNew.gI().addItemBag(player, item);
                                            InventoryServiceNew.gI().sendItemBags(player);
                    ...
                    if (this.mapId == 21 || this.mapId == 22 || this.mapId == 23) {
                        if (player.iDMark.getIndexMenu() == ConstNpc.BANKING) {
                            switch (select) {
                                ...
                                //             + "\nSố Dư : " + Util.format(player.getSession().vnd) + " VNĐ "
                                //             + "\n|7|Tỉ Lệ Quy Đổi Hiện Tại Là : Thỏi Vàng X" + Manager.TLDOITV + ", Hồng Ngọc X" + Util.format(Manager.TLDOIHN) + ", Xu BẠC X" + Util.format(Manager.TLDOIXUBAC) + ", Xu VÀNG X" + Util.format(Manager.TLDOIXUVANG)
                                //             + "\n|5|(Giới Hạn Quy Đồi Là 1000 tức không quá 1TR VNĐ)"
                                //             + "\n" + "Ví Dụ : Nhập vào 1 = 1.000VNĐ = " + Manager.TLDOITV + " Thỏi Vàng "
                                //             + "\n" + "Ví Dụ : Nhập vào 1 = 1.000VNĐ = " + Util.format(Manager.TLDOIHN * 1000) + " Hồng Ngọc"
                                //             + "\n" + "Ví Dụ : Nhập vào 1 = 1.000VNĐ = " + Util.format(Manager.TLDOIXUVANG) + " Thỏi Bạc"
                                //             + "\n" + "Ví Dụ : Nhập vào 1 = 1.000VNĐ = " + Util.format(Manager.TLDOIXUBAC) + " Thỏi Đồng",
                                //             "Đổi\nThỏi Vàng", "Đổi\nHồng Ngọc", "Đổi\n Thỏi Bạc", "Đổi\n Thỏi Đồng");
                                //     break;
                                // case 1:
                                ...
                                //             + "|2|Chào bạn : " + player.name
                                //             + "\nSố Dư : " + Util.format(player.getSession().vnd) + " VNĐ\n"
                                //             + "Bạn có chắc muốn mua đệ tử không?\n",
            ...
            public void openBaseMenu(Player pl) {
                if (canOpenNpc(pl)) {
                    if (this.mapId == 52) {
                        ...
                        //createOtherMenu(pl, 0, DaiHoiVoThuatService.gI(DaiHoiVoThuat.gI().getDaiHoiNow()).Giai(pl), "Thông tin\nChi tiết", DaiHoiVoThuatService.gI(DaiHoiVoThuat.gI().getDaiHoiNow()).CanReg(pl) ? "Đăng ký" : "OK");
                ...
                if (canOpenNpc(player) && this.mapId == 46) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        ...
                        if (player.clan != null && player.clan.ConDuongRanDoc != null && player.clan.gobosscdrd) {
                            ...
                            message = "Ta giúp cậu đổi Điểm Săn Boss lấy các vật phẩm giá trị \n"
                                    + "50 Điểm Săn Boss đổi 1k5 Hồng Ngọc \n"
                                    + "Bạn đang có: " + player.pointSb + " Điểm Săn Boss \n";
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, message, "Đổi 50 Điểm Lấy Hồng Ngọc", "Đóng");
                        }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player) && this.mapId == 46) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
//                            case 0:
//                                if (player.pointSb > 100) {
//                                    player.pointSb -= 100;
//                                    Item daskhvip = ItemService.gI().createNewItem((short)1466, 1);
//                                    InventoryServiceNew.gI().sendItemBags(player);
//                                    InventoryServiceNew.gI().addItemBag(player, daskhvip);
//                                    this.npcChat(player, "Bạn nhận được Đá SKH Vip");
//                                }
//                                else {
//                                    this.npcChat(player, "Bạn không đủ 100 Điểm Săn Boss");
//                                }
//                                break;
                            case 0:
                                if (player.pointSb > 50) {
                                    player.pointSb -= 50;
                                    player.inventory.ruby += 1500;
                                    this.npcChat(player, "Bạn nhận được Hồng Ngọc");
                                } else {
                                    this.npcChat(player, "Bạn không đủ 50 Điểm Săn Boss");
                                }
                                break;
                        }
                    }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|6|Ta sẽ giúp người trở lên mạnh mẽ hơn mạnh mẽ hơn",
                                "Khảm Ngọc \nBội", "Mở Phong \nẤn Trang Bị", "Đổi Ấn", "Nâng\n Cuốn Sách", "Chế Tạo\n Phôi Đục Lỗ");
                    }
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, ConstNpc.KHAM_NGOC_BOI,
                                            "Con muốn Khảm Ngọc Bội phải không",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, ConstNpc.KICH_AN,
                                            "Con muốn Kích Ấn trang bị phải không",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.DOI_AN,
                                            "Con muốn Đổi Ấn mới phải không",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                                case 3:
                                    this.createOtherMenu(player, ConstNpc.SACH_TUYET_KI,
                                            "Con muốn nâng Cuốn Sách phải không",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                                case 4:
                                    this.createOtherMenu(player, ConstNpc.CHE_TAO_PHOI,
                                            "Con muốn chế tạo Phôi Đục Lỗ phải không",
                                            "Đồng Ý", "Hướng Dẫn");
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.KHAM_NGOC_BOI) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.KHAM_NGOC_BOI);
                                    break;
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần có 1 Ngọc Bội và 1 đá Khảm Ngọc Bội \n "
                                            + "Ngọc Bội có 2 loại Thường và Vip, loại Thường khảm đá nhận ngẫu nhiên chỉ số 1-5%, loại Vip khảm đá nhận ngẫu nhiên chỉ số 5-10%\n"
                                            + "Đá Khảm Ngọc Bội có 3 loại SĐ, HP và KI. Muốn ngọc bội có chỉ số nào hãy để đá loại đó vào \n"
                                            + "Ngọc Bội Thường và Vip mua tại shop, Đá Khảm Ngọc Bội săn boss tương lai có tỉ lệ rơi");
                                    break;

                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.KICH_AN) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.KICH_AN);
                                    break;
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần có 1 Trang Bị bất kì (Áo, quần, găng, giày, rada), 1 Sách Cổ và 1 Ấn \n "
                                            + "Ấn có 3 loại: Ấn Mộc, Ấn Thủy, Ấn Hỏa, khảm Ấn nào sẽ nhận được chỉ số tương ứng\n"
                                            + "Ví dụ: Khảm Ấn Mộc thì trang bị sẽ mang chỉ số Mộc Ấn\n"
                                            + "Sách Cổ và Ấn săn boss Mabu tại Đại Hội Võ Thuật có tỉ lệ rớt\n"
                                            + "5 món Mộc Ấn tăng 10% HP \n"
                                            + "5 món Thủy Ấn tăng 10% KI \n"
                                            + "5 món Hỏa Ấn tăng 10% SĐ \n"
                                            + "Lưu ý: Ấn không thể xóa, hãy cân nhắc trước khi khảm"
                                    );
                                    break;

                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.DOI_AN) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.DOI_AN);
                                    break;
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần có 2 cùng loại \n "
                                            + "Sau khi đổi, 2 Ấn cũ sẽ mất và nhận được một Ấn mới\n"
                                    );
                                    break;

                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.SACH_TUYET_KI) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.SACH_TUYET_KI);
                                    break;
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần có 1 Cuốn Sách và 1 Sách Cũ \n"
                                            + "Cuốn Sách 1 và Sách Cũ đi phó bản Khí Gas Hủy Diệt ở NPC POPO tại làng Aru"
                                            + "Sau khi nâng, bạn sẽ nhận được Cuốn Sách cấp cao hơn với chỉ số ngẫu nhiên\n"
                                            + "Cấp 2: 2-5% || Cấp 3: 5-8% || Cấp 4: 8-11% || Cấp 5: 11-14% || Cấp 6: 14-17% || Cấp 7: 17-20%"
                                    );
                                    break;

                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.CHE_TAO_PHOI) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.CHE_TAO_PHOI);
                                    break;
                                case 1:
                                    Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                            "Cần 5 Mảnh Vỡ Phôi \n"
                                            + "Mảnh Vỡ Phôi mở rương khi chiến thắng Đại Hội Võ Thuật 23 \n"
                                            + "Lưu ý: Chỉ có ở rương 11 \n"
                                            + "Chế tạo thành công nhận Phôi Đục Lỗ, dùng để pha lê hóa 8 sao"
                                    );
                                    break;
                            ...
                            switch (player.combineNew.typeCombine) {
                                case CombineServiceNew.KHAM_NGOC_BOI:
                                    switch (select) {
                                        case 0:
                                            CombineServiceNew.gI().KhamNgocBoi(player);
                                            break;
                                    }
                                    break;
                                case CombineServiceNew.KICH_AN:
                                    switch (select) {
                                        case 0:
                                            CombineServiceNew.gI().KichAn(player);
                                            break;
                                    }
                                    break;
                                case CombineServiceNew.DOI_AN:
                                    switch (select) {
                                        case 0:
                                            CombineServiceNew.gI().DoiAnMoc(player);
                                            break;
                                        case 1:
                                            CombineServiceNew.gI().DoiAnThuy(player);
                                            break;
                                        case 2:
                                            CombineServiceNew.gI().DoiAnHoa(player);
                                            break;
                                    }
                                    break;
                                case CombineServiceNew.SACH_TUYET_KI:
                                    switch (select) {
                                        case 0:
                                            CombineServiceNew.gI().NangCuonSach(player);
                                            break;
                                    }
                                    break;
                                case CombineServiceNew.CHE_TAO_PHOI:
                                    switch (select) {
                                        case 0:
                                            CombineServiceNew.gI().CheTaoPhoi(player);
                                            break;
                                    }
                                    break;
                            }
...
//                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Nhận quà\nđền bù");
                ...
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                Service.gI().sendPopUpMultiLine(player, tempId, avartar,
                                        "Muốn vào cổng cần 1 Viên Nén Khí Gas (Mua tại Santa) \n"
                                        + "Boss có tỉ lệ rơi Cuốn Sách 1 và Sách Cũ \n"
                                        + "Cấp càng lớn tỉ lệ rớt càng cao, nhưng ta khuyên ngươi nên đi cấp 1-20"
                                );
                                return;
                            case 1:
                                if (player.clan != null) {
    ...
    public static Npc xenuocmia(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Sự Kiện Mùa Hè\n"
                            + "|2|Ta Có Bán Nước Mía Thơm Ngon, Mau Đến Ủng Họ Giải Nhiệt Mùa Hè\n"
                            + "Mang Cho Ta 2 Nước Đá và 5 Khúc Mía, Ngươi Sẽ Nhận Ngẫu Nhiên Một Thứ Thức Uống: \n"
                            + "+ Ly Nước Mía Khổng Lồ: hiệu lực 10 phút chống nóng, + 10% HP\n"
                            + "+ Ly Nước Mía Thơm: hiệu lực 10 phút chống nóng, + 10% HP + 10% chí mạng\n"
                            + "+ Ly Nước Mía Sầu Riêng: hiệu lực 10 phút chống nóng, + 10% HP + 10% giáp + 10% sức đánh\n",
                            "Đổi\nNước Mía", "Đóng");
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    ...
                                    Item KhucMia = null;
                                    try {
                                        NuocDa = InventoryServiceNew.gI().findItemBag(player, 1528);
                                        KhucMia = InventoryServiceNew.gI().findItemBag(player, 1529);
                                    } catch (Exception e) {
                                    }
                                    if (NuocDa == null || NuocDa.quantity < 2) {
                                        this.npcChat(player, "Bạn không đủ x2 Nước Đá");
                                    } else if (KhucMia == null || KhucMia.quantity < 5) {
                                        this.npcChat(player, "Bạn không đủ x5 Khúc Mía");
                                        ...
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, NuocDa, 2);
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, KhucMia, 5);
                                        Service.gI().sendMoney(player);
                                        int rdNuocMia = Util.nextInt(1525, 1527);
                                        Item NuocMia = ItemService.gI().createNewItem((short) rdNuocMia);
                                        NuocMia.itemOptions.add(new Item.ItemOption(210, 1));
                                        InventoryServiceNew.gI().addItemBag(player, NuocMia);
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Bạn nhận được " + NuocMia.template.name);
                                    }
                                    break;
                            }
                        }
    ...
    public static Npc gohanbaibien(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Sự Kiện Mùa Hè\n"
                            + "|2|Mua Kem Trái Cây tại Satan, ăn hết kem để lấy Que Kem quay thưởng tại đây \n"
                            + "Mỗi lần tốn 1 Que Kem \n"
                            + "Quay thưởng có tỉ lệ trúng nhiều vật phẩm hấp dẫn: \n"
                            + "+ Pet Capybara: 1-10% chỉ số, có tỉ lệ vĩnh viễn \n"
                            + "+ Ngọc Rồng 3-7s\n"
                            + "+ Nước Đá (dùng mua Nước Mía tại đầu làng) \n"
                            + "Lưu ý: quay thưởng có tỉ lệ thất bại",
                            "Quay Thưởng", "Đóng");
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    Item queKem = null;
                                    try {
                                        queKem = InventoryServiceNew.gI().findItemBag(player, 1531);
                                    } catch (Exception e) {
                                    }
                                    if (queKem == null || queKem.quantity < 1) {
                                        this.npcChat(player, "Bạn không đủ x1 Que Kem");
                                    } else if (player.inventory.gold < 100_000_000) {
                                        this.npcChat(player, "Bạn không đủ 100tr vàng");
                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                        ...
                                        player.inventory.gold -= 100_000_000;
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, queKem, 1);
                                        Service.gI().sendMoney(player);
                                        if (Util.isTrue(80, 100)) {
                                            if (Util.isTrue(90, 100)) {
                                                int[] items = {1528, 16, 17, 18, 19, 20};
                                                int index = Util.nextInt(0, items.length - 1);
                                                Item gift = ItemService.gI().createNewItem((short) items[index]);
                                                gift.itemOptions.add(new Item.ItemOption(210, 1));
                                                InventoryServiceNew.gI().addItemBag(player, gift);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được " + gift.template.name);
                                            } else {
                                                int item = Util.nextInt(1583, 1585);
                                                Item gift = ItemService.gI().createNewItem((short) item);
                                                gift.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 10)));
                                                gift.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 10)));
                                                gift.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 10)));
                                                gift.itemOptions.add(new Item.ItemOption(210, 1));
                                                InventoryServiceNew.gI().addItemBag(player, gift);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được " + gift.template.name);
                                            ...
                                            this.npcChat(player, "Chúc bạn may mắn lần sau");
                                        }
...
//                    return hungvuong(mapId, status, cx, cy, tempId, avatar);
                ...
                case ConstNpc.XEMIA:
                    return xenuocmia(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.GOHANBAIBIEN:
                    return gohanbaibien(mapId, status, cx, cy, tempId, avatar);
                default:
                            ...
                            case 1:
                                if (player.pet != null) {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.IGNORE_MENU, 12639,
                                            "|7|[ Info Player Pet : " + player.pet.name.substring(1) + " ]\n"
...
//                        break;
                    case ConstNpc.MUA_DE:
                        switch (select) {
                            ...
                            case 0:
                                if (player.pet != null) {
                                    this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_KEFLA, "Bạn có chắc muốn mua đệ Cumber SSJ2(10%) không?", "Đồng Ý", "Không");
                                } else {
                                    Service.getInstance().sendThongBao(player, "Yêu cầu có đệ tử thường");
                                }
                                break;
                            case 1:
                                if (player.pet != null) {
                                    this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_GOKU, "Bạn có chắc muốn mua đệ Goku Ultra (20%) không?\n", "Đồng Ý", "Không");
                                } else {
                                    Service.getInstance().sendThongBao(player, "Yêu cầu có đệ tử thường");
                                }
                                break;
                            case 2:
                                if (player.pet != null) {
                                    this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_CUMBER, "Bạn có chắc muốn mua đệ Vegeta Blue (20%) không?\n", "Đồng Ý", "Không");
                                } else {
                                    Service.getInstance().sendThongBao(player, "Yêu cầu có đệ tử thường");
                                }
                                break;
                            ...
                            case 1:
                                if (player.getSession().vnd < 10000) {
                                    ...
                                    if (player.pet != null) {
                                        ...
                                        player.pet.gender = 1;
                                        ChangeMapService.gI().exitMap(player.pet);
                                        Service.gI().sendThongBao(player, "Đã đổi thành công hành tinh Namec");
                                    } else {
                                        Service.gI().sendThongBao(player, "Bạn làm gì có đệ");
                                    }
                                }
                            ...
                            case 0:
                                if (player.getSession().vnd < 30000) {
                                    ...
                                    if (player.pet != null && player.pet.inventory.itemsBody.get(0).isNotNullItem() == false && player.pet.inventory.itemsBody.get(1).isNotNullItem() == false && player.pet.inventory.itemsBody.get(2).isNotNullItem() == false && player.pet.inventory.itemsBody.get(3).isNotNullItem() == false && player.pet.inventory.itemsBody.get(4).isNotNullItem() == false && player.pet.inventory.itemsBody.get(5).isNotNullItem() == false && player.pet.inventory.itemsBody.get(6).isNotNullItem() == false) {
                                        ...
                                        Service.gI().sendThongBao(player, "Bạn mua thành công đệ Vegata Blue");
                                    } else {
                            ...
                            case 0:
                                if (player.getSession().vnd < 30000) {
                                    ...
                                    if (player.pet == null) {
                                        ...
                                        Service.gI().sendThongBao(player, "Bạn mua thành công đệ Songoku Ultra");
                                    }
                                    if (player.pet != null && player.pet.inventory.itemsBody.get(0).isNotNullItem() == false && player.pet.inventory.itemsBody.get(1).isNotNullItem() == false && player.pet.inventory.itemsBody.get(2).isNotNullItem() == false && player.pet.inventory.itemsBody.get(3).isNotNullItem() == false && player.pet.inventory.itemsBody.get(4).isNotNullItem() == false && player.pet.inventory.itemsBody.get(5).isNotNullItem() == false && player.pet.inventory.itemsBody.get(6).isNotNullItem() == false) {
                                        try {
                                            int sum = player.getSession().vnd - 30000;
                        ...
                        switch (select) {
                            case 0:
                                if (player.getSession().vnd < 1000) {
                                    Service.gI().sendThongBao(player, "Còn thiếu " + (1000 - player.getSession().vnd));
                                } else {
                                    if (player.pet == null) {
                                    ...
                                    if (player.pet.playerSkill.skills.get(1).skillId != -1 && player.pet.playerSkill.skills.get(2).skillId != -1) {
                                        try {
                                            int sum = player.getSession().vnd - 1000;
                                            GirlkunDB.executeUpdate(
                                                    "update account set vnd = ? where id = ?", sum,
                                                    player.account_id);
                                            player.getSession().vnd = sum;
                                ...
                                break;
                            case 1:
                                if (player.getSession().vnd < 2000) {
                                    Service.gI().sendThongBao(player, "Còn thiếu " + (2000 - player.getSession().vnd));
                                } else {
                                    if (player.pet == null) {
                                        Service.gI().sendThongBao(player, "Ngươi làm gì có đệ tử?");
                                        break;
                                    ...
                                    if (player.pet.playerSkill.skills.get(2).skillId != -1 && player.pet.playerSkill.skills.get(3).skillId != -1) {
                                        try {
                                            int sum = player.getSession().vnd - 2000;
