...
public class PlayerDAO {
    ...
    public static boolean createNewPlayer(int userId, String name, byte gender, int hair) {
        try {
            ...
            dataArray.add(1000000000); //vàng nhận khi tạo nhân vật
            dataArray.add(5000); //ngọc xanh nhận khi tạo nhân vật
            ...
            dataArray.add(10); //level cây đậu thần
            ...
            int[] skillsArr = gender == 0 ? new int[]{0, 1, 6, 9, 10, 20, 22, 24, 19, 27}
                    : gender == 1 ? new int[]{2, 3, 7, 11, 12, 17, 18, 26, 19, 27}
                    : new int[]{4, 5, 8, 13, 14, 21, 23, 25, 19, 27};
...
//                   dataArray.add(player.rankSieuHang);
                ...
                //Logger.success("\n" + "SAVED DATABASE " + "----> " + player.name + "\n");
//                System.out.print("Online: " + Client.gI().getPlayers().size() + "\n");
